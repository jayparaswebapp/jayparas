...
export const RPC_ERROR_KEYS = [
  ...
  'invoice_not_amendable',
  'invoice_amend_gst_blocked',
...
const RPC_TO_I18N: Record<RpcErrorKey, string> = {
  ...
  invoice_not_amendable: 'billing.invoices.errors.notAmendable',
  invoice_amend_gst_blocked: 'billing.invoices.errors.amendGstBlocked',
  invoice_total_below_paid: 'billing.invoices.errors.totalBelowPaid',
  ...
  journal_lines_required: 'accounting.errors.linesRequired',
  journal_line_dr_xor_cr: 'accounting.errors.lineDrXorCr',
  journal_line_negative: 'accounting.errors.lineNegative',
  journal_account_missing: 'accounting.errors.accountMissing',
  journal_account_is_group: 'accounting.errors.accountIsGroup',
  journal_account_inactive: 'accounting.errors.accountInactive',
  journal_unbalanced: 'accounting.errors.unbalanced',
  journal_already_cancelled: 'accounting.errors.alreadyCancelled',
  journal_auto_posted: 'accounting.errors.autoPosted',
  account_code_required: 'accounting.errors.codeRequired',
  account_name_required: 'accounting.errors.nameRequired',
  account_parent_required: 'accounting.errors.parentRequired',
  account_parent_missing: 'accounting.errors.parentMissing',
  account_code_duplicate: 'accounting.errors.codeDuplicate',
  wipe_confirmation_missing: 'admin.wipe.errors.confirmationMissing',
