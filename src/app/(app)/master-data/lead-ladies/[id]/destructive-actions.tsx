...
import { restoreLeadLadyAction, softDeleteLeadLadyAction } from '../actions';
...
export function DestructiveActions({
  ...
  const action = isDeleted ? restoreLeadLadyAction : softDeleteLeadLadyAction;
  ...
  return (
    ...
    >
      <input type="hidden" name="id" value={leadLadyId} />
