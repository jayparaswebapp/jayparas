...
import { restoreBillingCustomerAction, softDeleteBillingCustomerAction } from '../actions';
...
export function DestructiveActions({
  ...
  const action = isDeleted ? restoreBillingCustomerAction : softDeleteBillingCustomerAction;
