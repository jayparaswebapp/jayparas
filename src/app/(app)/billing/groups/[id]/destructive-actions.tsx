...
import { restoreCustomerGroupAction, softDeleteCustomerGroupAction } from '../actions';
...
export function DestructiveActions({
  ...
  const action = isDeleted ? restoreCustomerGroupAction : softDeleteCustomerGroupAction;
