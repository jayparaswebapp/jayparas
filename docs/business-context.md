# Jai Paras — Business Context

## What the business does

Jai Paras is a Valsad-based manufacturer of custom rakhis (the thread-bracelet exchanged during the Indian festival of Raksha Bandhan). Production is seasonal, peaking in July–August. The main centre in Valsad designs the products and prepares raw material packets; the actual assembly is done by women's groups in six surrounding villages on a contract-labour basis.
